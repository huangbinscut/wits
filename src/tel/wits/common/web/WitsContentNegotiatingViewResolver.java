...
public class WitsContentNegotiatingViewResolver extends ContentNegotiatingViewResolver {
    
    private static final Logger LOGGER = LoggerFactory.getLogger(WitsContentNegotiatingViewResolver.class);
